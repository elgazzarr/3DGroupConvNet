...
from dltk.groupy.gconv.make_gconv_indices import make_c4_z2_indices, make_c4_p4_indices
from dltk.groupy.gconv.tensorflow_gconv.transform_filter import transform_filter_2d_nchw, transform_filter_2d_nhwc
...
def ch_trans_filter(w, inds):
    ...
    from dltk.groupy.gconv.chainer_gconv.transform_filter import TransformGFilter
