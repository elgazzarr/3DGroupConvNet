from dltk.groupy.gconv.chainer_gconv.splitgconv2d import SplitGConv2D
from dltk.groupy.gconv.make_gconv_indices import make_d4_z2_indices, make_d4_p4m_indices
