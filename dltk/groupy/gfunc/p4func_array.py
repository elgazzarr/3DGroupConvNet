import numpy as np
import dltk.groupy.garray.p4_array as p4a
from dltk.groupy.gfunc.gfuncarray import GFuncArray
...
def tst():
    ...
    from dltk.groupy.garray.p4_array import meshgrid, u_range, v_range, rotation
